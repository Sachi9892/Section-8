...
@Tag(
        name = "CRUD REST APIs for Loans in Sachin Sonar's Bank App",
        description = "CRUD REST APIs in Bank-App to CREATE, UPDATE, FETCH AND DELETE loan details"
)
@RestController
...
public class LoansController {
    ...
    @Operation(
            ...
            description = "REST API to create new loan inside Bank-App"
    )
    @ApiResponses({
            @ApiResponse(
                    responseCode = "201",
